...
def extraer_proposiciones(enunciado):
    ...
    # Corrección de "NO" a "~" en la fórmula
...
def construir_arbol(variables):
    ...
    cola = [(raiz, 0)]  # Empezar desde el primer índice
    ...
    while cola:
        ...
        if idx < len(lista_variables):
            ...
            padre.derecha = p_nodo_true  # Bifurcación derecha A1 = true
            padre.izquierda = p_nodo_false  # Bifurcación izquierda A1 = false
